  ...
  render() {
    ...
    return (
      <Box mb={this.props.isOnboarding ? 0 : 4}>
        ...
        <Text my={3}>Wähle die Medien aus, deren Molos (Nachrichten und Informationen) dich interessieren.</Text>
        <Box mb={3}>
          {media.map(d => this.renderOrganisation(d))}
        </Box>
        <Heading mb={3}>Welchen Kollektiven willst du folgen?</Heading>
        <Text my={3}>Wähle die Kollektive aus, deren Molos (Nachrichten und Informationen)dich interessieren.</Text>
        <Box mb={3}>
