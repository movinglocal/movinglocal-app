    ...
    return (
      <Box p={3} css={{ flexGrow: 1, overflowY: 'auto', '-webkit-overflow-scrolling': 'touch' }}>
        ...
        <Text>
          ...
          <br />
          <br />
          Das ZeMKI ist eine Einrichtung der Universität Bremen.
          ...
          Prof. Dr. Andreas Hepp, Sprecher des ZeMKI
        </Text>
        ...
        <Text>
          ...
          verursacht wurden sind grundsätzlich ausgeschlossen, sofern kein nachweislich
          vorsätzliches oder
          grob fahrlässiges Verschulden vorliegt. Wir behalten uns ausdrücklich vor,
        ...
        <Text>
          Unsere Internetseite enthält Links zu Internetseiten Dritter,
          auf deren Inhalte wir keinen Einfluss haben.
          Wir sind als Anbieter für eigene Inhalte nach den allgemeinen Gesetzen verantwortlich.
          Für fremde Inhalte, die über Links zur Nutzung bereitgestellt werden,
          übernehmen wir keinerlei Verantwortung und machen uns deren Inhalt nicht zu Eigen.
          ...
          Wir sind nicht nach dem Gesetz verpflichtet,
          die fremden Inhalte der verlinkten Seite ständig auf
          Veränderungen zu überprüfen, die eine Verantwortlichkeit
          begründen könnten. Bei bekannt werden von Rechtsverletzungen
          werden wir derartige Links aber umgehend entfernen,
